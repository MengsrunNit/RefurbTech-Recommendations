...
import { listModels, getPredictionSeries, parseNumber, MODELS } from "../models/iphonePricingModel.js";
...
// New: phone predictions series using the fit for the chosen modelKey
...
router.get("/phone-predictions", (req, res) => {
  try {
